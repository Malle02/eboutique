 ...
 */
final class Version20250311202029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, DROP cart_id, CHANGE adress address VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD cart_id INT DEFAULT NULL, DROP roles, CHANGE address adress VARCHAR(255) DEFAULT NULL');
